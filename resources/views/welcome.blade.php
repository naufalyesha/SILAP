        ...
        <div class="row">
            <div class="content">
                <div class="content-box">
                    ...
                    <p>Kami adalah penyedia layanan penyewaan lapangan olahraga yang berdedikasi untuk memberikan pengalaman
                        terbaik bagi Anda. Dengan berbagai jenis lapangan yang tersedia, kami berkomitmen untuk memenuhi
                        kebutuhan olahraga Anda, baik untuk latihan rutin, pertandingan, maupun acara khusus.</p>
                </div>
                <div class="content-box">
                    <h3>Misi Kami</h3>
                    <p>Kami percaya bahwa olahraga adalah bagian penting dari gaya hidup sehat dan kebersamaan komunitas.
                        Misi kami adalah menyediakan fasilitas lapangan berkualitas tinggi yang mudah diakses oleh semua
                        orang. Kami berusaha untuk menciptakan lingkungan yang menyenangkan dan mendukung untuk semua
                        pengguna lapangan kami.</p>
                </div>
                <div class="content-box">
                    <h3>Visi Kami</h3>
                    <p>Visi kami adalah menjadi penyedia layanan penyewaan lapangan terbaik dan terpercaya di lokasi Anda,
                        dengan terus meningkatkan kualitas fasilitas dan pelayanan kami. Kami ingin menjadi tempat pilihan
                        utama bagi para penggemar olahraga untuk beraktivitas dan bersosialisasi.</p>
                </div>
                <div class="content-box">
                    <h3>Mengapa Memilih Kami?</h3>
                    <ul>
                        <li><strong>Kualitas Lapangan:</strong> Kami menawarkan lapangan dengan kondisi terbaik, baik dari
                            segi perawatan maupun fasilitas pendukung.</li>
                        <li><strong>Kemudahan Pemesanan:</strong> Sistem pemesanan online kami dirancang untuk memudahkan
                            Anda dalam memilih dan memesan lapangan sesuai kebutuhan.</li>
                        <li><strong>Harga Terjangkau:</strong> Kami menyediakan berbagai pilihan harga yang kompetitif
                            dengan berbagai promo menarik.</li>
                        <li><strong>Layanan Pelanggan:</strong> Tim kami siap membantu Anda dengan segala pertanyaan dan
