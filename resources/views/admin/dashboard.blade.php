                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="#" class="sidebar-link collapsed" data-bs-target="#pages" data-bs-toggle="collapse" aria-expanded="false">
                            <i class="fa-solid fa-file-lines pe-2"></i> Pages
                        </a>
                    ...
                    <li class="sidebar-item">
                        <a href="#" class="sidebar-link collapsed" data-bs-target="#posts" data-bs-toggle="collapse" aria-expanded="false">
                            <i class="fa-solid fa-sliders pe-2"></i> Posts
                        </a>
                        ...
                        <ul id="multi" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                ...
                                <ul id="level-1" class="sidebar-dropdown list-unstyled collapse">
                                    ...
                                    <li class="sidebar-item">
                                      @if (Auth::user()->role == 'admin')
                                          <a href="#" class="sidebar-link">Menu Admin</a>
                                      @endif
                                      @if (Auth::user()->role == 'vendor')
                                          <a href="#" class="sidebar-link">Menu Vendor</a>
                                      @endif
                                      @if (Auth::user()->role == 'customer')
                                          <a href="#" class="sidebar-link">Menu Customer</a>
                                      @endif
                                  </li>
                                </ul>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" class="nav-icon pe-md-0">
                                <img src="{{ asset('image/profile.jpeg') }}" class="avatar img-fluid rounded" alt="Profile Picture">
                            </a>
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a href="#" class="text-muted"><strong>CodzSword</strong></a>
                            </p>
                        </div>
